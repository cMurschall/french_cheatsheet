...
- **Attendre** (warten): *j'attends, tu attends, il/elle attend, nous attendons, vous attendez, ils/elles attendent*
...
être nur mit Reflexiven Verben und Bewegungen
...
| Person     | **-er** *(aimer)*     | **-ir** *(finir)*    | **-ir** *(dormir)*   | **-re** *(vendre)*    |
|------------|------------------------|-----------------------|-----------------------|-----------------------|
| je/j’      | **avais** aim**é**     | **avais** fin**i**    | **avais** dormi       | **avais** vend**u**   |
| tu         | **avais** aim**é**     | **avais** fin**i**    | **avais** dormi       | **avais** vend**u**   |
| il/elle/on | **avait** aim**é**     | **avait** fin**i**    | **avait** dormi       | **avait** vend**u**   |
| nous       | **avions** aim**é**    | **avions** fin**i**   | **avions** dormi      | **avions** vend**u**  |
| vous       | **aviez** aim**é**     | **aviez** fin**i**    | **aviez** dormi       | **aviez** vend**u**   |
| ils/elles  | **avaient** aim**é**   | **avaient** fin**i**  | **avaient** dormi     | **avaient** vend**u** |

**Beispiele:**

- **J'avais aimé cette chanson avant qu'elle ne devienne populaire.**  
  *(Ich hatte dieses Lied gemocht, bevor es populär wurde.)*
- **Il avait fini son travail avant midi.**  
  *(Er hatte seine Arbeit vor Mittag beendet.)*
- **Nous avions dormi avant le voyage.**  
  *(Wir hatten vor der Reise geschlafen.)*
- **Elles avaient vendu tous les billets.**  
  *(Sie hatten alle Tickets verkauft.)*
...
- **Anwendung:**
  - Vergangene Handlung, die unmittelbar vor einer anderen Handlung im Passé simple stattfand

| Person     | **-er** *(aimer)*     | **-ir** *(finir)*    | **-ir** *(dormir)*   | **-re** *(vendre)*    |
|------------|------------------------|-----------------------|-----------------------|-----------------------|
| je/j’      | **eus** aim**é**       | **eus** fin**i**      | **eus** dormi         | **eus** vend**u**     |
| tu         | **eus** aim**é**       | **eus** fin**i**      | **eus** dormi         | **eus** vend**u**     |
| il/elle/on | **eut** aim**é**       | **eut** fin**i**      | **eut** dormi         | **eut** vend**u**     |
| nous       | **eûmes** aim**é**     | **eûmes** fin**i**    | **eûmes** dormi       | **eûmes** vend**u**   |
| vous       | **eûtes** aim**é**     | **eûtes** fin**i**    | **eûtes** dormi       | **eûtes** vend**u**   |
| ils/elles  | **eurent** aim**é**    | **eurent** fin**i**   | **eurent** dormi      | **eurent** vend**u**  |

**Beispiele:**

- **Dès qu'ils eurent fini, ils partirent.**  
  *(Sobald sie fertig waren, gingen sie.)*
- **Elle eut vendu sa maison avant de déménager.**  
  *(Sie hatte ihr Haus verkauft, bevor sie umzog.)*
...
- **Anwendung:**
  ...
  - Handlungen, bei denen eine Absicht besteht
...
- **Je vais aimer ce livre, j'en suis sûr.**  
  *(Ich werde dieses Buch mögen, da bin ich sicher.)*
- **Nous allons finir le projet demain.**  
  *(Wir werden das Projekt morgen abschließen.)*
- **Tu vas dormir tôt ce soir.**  
  *(Du wirst heute Abend früh schlafen.)*
- **Ils vont vendre leur ancienne voiture.**  
  *(Sie werden ihr altes Auto verkaufen.)*
...
| Person     | **-er** *(aimer)*     | **-ir** *(finir)*    | **-ir** *(dormir)*    | **-re** *(vendre)*    |
|------------|------------------------|-----------------------|------------------------|-----------------------|
| je/j’      | aim**erai**            | fin**irai**           | dormir**ai**           | vend**rai**           |
| tu         | aim**eras**            | fin**iras**           | dormir**as**           | vend**ras**           |
| il/elle/on | aim**era**             | fin**ira**            | dormir**a**            | vend**ra**            |
| nous       | aim**erons**           | fin**irons**          | dormir**ons**          | vend**rons**          |
| vous       | aim**erez**            | fin**irez**           | dormir**ez**           | vend**rez**           |
| ils/elles  | aim**eront**           | fin**iront**          | dormir**ont**          | vend**ront**          |

**Beispiele:**

- **Il aimera toujours sa famille.**  
  *(Er wird seine Familie immer lieben.)*
- **Vous finirez ce travail la semaine prochaine.**  
  *(Ihr werdet diese Arbeit nächste Woche beenden.)*
- **Nous dormirons à l'hôtel ce soir.**  
  *(Wir werden heute Abend im Hotel schlafen.)*
- **Elles vendront des gâteaux au marché.**  
  *(Sie werden Kuchen auf dem Markt verkaufen.)*
...
| Person     | **-er** *(aimer)*      | **-ir** *(finir)*     | **-ir** *(dormir)*    | **-re** *(vendre)*     |
|------------|-------------------------|------------------------|------------------------|------------------------|
| je/j’      | **aurai** aim**é**      | **aurai** fin**i**     | **aurai** dorm**i**    | **aurai** vend**u**    |
| tu         | **auras** aim**é**      | **auras** fin**i**     | **auras** dorm**i**    | **auras** vend**u**    |
| il/elle/on | **aura** aim**é**       | **aura** fin**i**      | **aura** dorm**i**     | **aura** vend**u**     |
| nous       | **aurons** aim**é**     | **aurons** fin**i**    | **aurons** dorm**i**   | **aurons** vend**u**   |
| vous       | **aurez** aim**é**      | **aurez** fin**i**     | **aurez** dorm**i**    | **aurez** vend**u**    |
| ils/elles  | **auront** aim**é**     | **auront** fin**i**    | **auront** dorm**i**   | **auront** vend**u**   |

**Beispiele:**

- **Quand tu arriveras, j'aurai déjà aimé cette chanson.**  
  *(Wenn du ankommst, werde ich dieses Lied schon gemocht haben.)*
- **Ils auront fini le travail avant midi.**  
  *(Sie werden die Arbeit vor Mittag beendet haben.)*
- **Nous aurons dormi avant le voyage.**  
  *(Wir werden vor der Reise geschlafen haben.)*
- **Elle aura vendu tous les billets avant le spectacle.**  
  *(Sie wird alle Tickets vor der Vorstellung verkauft haben.)*
...
| Person     | **-er** *(aimer)*      | **-ir** *(finir)*      | **-ir** *(dormir)*     | **-re** *(vendre)*      |
|------------|-------------------------|-------------------------|-------------------------|-------------------------|
| je/j’      | aim**erais**            | fin**irais**            | dormir**ais**           | vendr**ais**            |
| tu         | aim**erais**            | fin**irais**            | dormir**ais**           | vendr**ais**            |
| il/elle/on | aim**erait**            | fin**irait**            | dormir**ait**           | vendr**ait**            |
| nous       | aim**erions**           | fin**irions**           | dormir**ions**          | vendr**ions**           |
| vous       | aim**eriez**            | fin**iriez**            | dormir**iez**           | vendr**iez**            |
| ils/elles  | aim**eraient**          | fin**iraient**          | dormir**aient**         | vendr**aient**          |

**Beispiele:**

- **Je aimerais voyager en France.**  
  *(Ich würde gerne nach Frankreich reisen.)*
- **Tu finirais ce livre si tu avais le temps.**  
  *(Du würdest dieses Buch beenden, wenn du Zeit hättest.)*
- **Pourriez-vous dormir avec ce bruit?**  
  *(Könntest du bei diesem Lärm schlafen?)*
- **Ils vendraient leur maison s'ils trouvaient einen Käufer.**  
  *(Sie würden ihr Haus verkaufen, wenn sie einen Käufer fänden.)*
...
| Person     | **-er** *(aimer)*       | **-ir** *(finir)*      | **-ir** *(dormir)*     | **-re** *(vendre)*       |
|------------|--------------------------|-------------------------|-------------------------|--------------------------|
| je/j’      | **aurais** aim**é**      | **aurais** fin**i**     | **aurais** dorm**i**    | **aurais** vend**u**     |
| tu         | **aurais** aim**é**      | **aurais** fin**i**     | **aurais** dorm**i**    | **aurais** vend**u**     |
| il/elle/on | **aurait** aim**é**      | **aurait** fin**i**     | **aurait** dorm**i**    | **aurait** vend**u**     |
| nous       | **aurions** aim**é**     | **aurions** fin**i**    | **aurions** dorm**i**   | **aurions** vend**u**    |
| vous       | **auriez** aim**é**      | **auriez** fin**i**     | **auriez** dorm**i**    | **auriez** vend**u**     |
| ils/elles  | **auraient** aim**é**    | **auraient** fin**i**   | **auraient** dorm**i**  | **auraient** vend**u**   |

**Beispiele:**

- **Elle aurait aimé venir, mais elle était occupée.**  
  *(Sie wäre gerne gekommen, aber sie war beschäftigt.)*
- **Nous aurions fini plus tôt sans die Verzögerungen.**  
  *(Wir hätten ohne die Verzögerungen früher fertig sein können.)*
- **Tu aurais dormi besser mit einem Kissen.**  
  *(Du hättest mit einem Kissen besser geschlafen.)*
- **Ils auraient vendu das Haus, wenn der Preis höher gewesen wäre.**  
  *(Sie hätten das Haus verkauft, wenn der Preis höher gewesen wäre.)*

---

\* *Verben wie **finir** folgen der regelmäßigen Konjugation auf **-ir**.*
